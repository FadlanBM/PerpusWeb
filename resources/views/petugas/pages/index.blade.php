                    ...
                    <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                        <div class="flex justify-between mb-6">
                            <div>
                                ...
                                <div class="text-sm font-medium text-gray-400">Peminjam</div>
                            </div>
                            <div class="dropdown">
                                ...
                                <ul
                                    ...
                                    <li>
                                        <a href="#"
                                            class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-blue-500 hover:bg-gray-50">Management User</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-blue-500 hover:bg-gray-50">Add User</a>
                                    </li>
                                    <li>
                                </ul>
                            </div>
